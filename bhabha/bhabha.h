...
void chain(){
	...
	//{
	    ...
	    //tt->Add(TString::Format("/spool/users/ovtin/outDmeson/simulation/BhaBha/23403-23430_1.3_1.0/psi3770_to_simBhaBha_%d.root",i).Data());   //4   10-11 - bad data runs ?
	    ...
	    //tt->Add(TString::Format("/spool/users/ovtin/outDmeson/simulation/BhaBha/23473-23522_2.2_1.5/psi3770_to_simBhaBha_%d.root",i).Data());   //6   16-19
