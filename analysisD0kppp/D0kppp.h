...
void chain(){
	...
	for(int i=1; i<=20; i++)   //Signal
	{
	    tt->Add(TString::Format("/store/users/ovtin/outDmeson/simulation/outsimD0_kppp/Signal/KemcAllowedOn_kNoiseReject3_kXTKey1_KcExp0_ATC_S1.0_A6.0_Z0.0_kinFit_v2/psi3770_to_simD0mesonSignal_%d.root",i).Data());
	...
	for(int i=1; i<=20; i++)   //DD BG
	{
	    if( i!=5 && i!=6 && i!=8 && i!=61 && i!=67 && i!=69 && i!=70 && i!=73 && i!=106 && i!=114 && i!=136 && i!=139 && i!=163 && i!=213 && i!=215 )
	    {
		//tt->Add(TString::Format("/store/users/ovtin/outDmeson/simulation/outsimD0_kppp/Bkg_eetoDD/KemcAllowedOn_kNoiseReject3_kXTKey1_KcExp0_ATC_S1.0_A6.0_Z0.0_v2/psi3770_to_simD0mesonBkg_eetoDD_%d.root",i).Data());
		tt->Add(TString::Format("/store/users/ovtin/outDmeson/simulation/outsimD0_kppp/Bkg_eetoDD/KemcAllowedOn_kNoiseReject3_kXTKey1_KcExp0_ATC_S1.0_A6.0_Z0.0/psi3770_to_simD0mesonBkg_eetoDD_%d.root",i).Data());
		//tt->Add(TString::Format("/store/users/ovtin/outDmeson/simulation/outsimD0_kppp/Bkg_eetoDD/all_modes_not_kppp/KemcAllowedOn_kNoiseReject3_kXTKey1_KcExp0_ATC_S1.0_A6.0_Z0.0/psi3770_to_simD0mesonBkg_eetoDD_%d.root",i).Data());
		//tt->Add(TString::Format("/store/users/ovtin/outDmeson/simulation/outsimD0_kppp/Bkg_eetoDD/v11/KemcAllowedOn_kNoiseReject3_kXTKey1_KcExp0_ATC_S1.0_A6.0_Z0.0/psi3770_to_simD0mesonBkg_eetoDD_%d.root",i).Data());
	    }
	}
    }
}
