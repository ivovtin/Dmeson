...
*/
  ...
  if( key==2004 ) {
      ...
      if (atc ){
	  infile = "dat/KemcAllowedOn_kNoiseReject3_kXTKey1_KcExp0_ATC/kppp_exp_2016-17_KemcAllowedOn_kNoiseReject3_1.0150_ATC.dat";
	  //infile = "dat/KemcAllowedOn_kNoiseReject3_kXTKey1_KcExp0_ATC/kppp_exp_2016-17_KemcAllowedOn_kNoiseReject3_1.0150_ntrphe1.5_ATC.dat";
	  mbcmax = 70;
	  rmax = 70.;
	  ...
	  infile = "dat/KemcAllowedOn_kNoiseReject3_kXTKey1_KcExp0/kppp_exp_2016-17_KemcAllowedOn_kNoiseReject3_1.0150.dat";
	  mbcmax = 120;
	  rmax = 120.;
