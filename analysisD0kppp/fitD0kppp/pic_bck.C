{
  ...
  //FILE* file = fopen(TString("dat/KemcAllowedOn_kNoiseReject3_kXTKey1_KcExp0/kppp_uds_KemcAllowedOn_kNoiseReject3_kXTKey1_KcExp0_S1.0_A6.0_Z0.0.dat").Data(),"r");
  FILE* file = fopen(TString("dat/KemcAllowedOn_kNoiseReject3_kXTKey1_KcExp0_ATC/kppp_uds_KemcAllowedOn_kNoiseReject3_kXTKey1_KcExp0_S1.0_A6.0_Z0.0_ATC.dat").Data(),"r");
  while (!feof(file)) {
    double mbc,de,dp;
  ...
  //file = fopen(TString("gen/KemcAllowedOn_kNoiseReject3_kXTKey1_KcExp0/bck_S1.0_A6.0_Z0.0.gen").Data(),"r");
  file = fopen(TString("gen/KemcAllowedOn_kNoiseReject3_kXTKey1_KcExp0_ATC/bck_S1.0_A6.0_Z0.0.gen").Data(),"r");
  while (!feof(file)) {
    double mbc,de,dp;
    if (fscanf(file,"%lf %lf %lf", &mbc,&de,&dp) == 3) {
      nt2.Fill(mbc,de,dp);
