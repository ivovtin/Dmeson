...
void TMVAMulticlass( TString myMethodList = "" )
{
   ...
   //signal->Add("/home/ovtin/development/Dmeson/analysisD0/MVA/infiles/signal.root/et");
   signal->Add("/home/ovtin/development/Dmeson/analysisD0/MVA/infiles/signal_all_KemcAllowedOn_kNoiseReject3_kXTKey1_KcExp0_ATC_S1.0_A6.0_Z0.0.root/et");

   TChain* background1 = new TChain("background1 ","background1 ");
   background1->Add("/home/ovtin/development/Dmeson/analysisD0/MVA/infiles/uds.root/et");

   TChain* background2 = new TChain("background2 ","background2 ");
   background2->Add("/home/ovtin/development/Dmeson/analysisD0/MVA/infiles/dbck.root/et");
   ...
   TCut Cuts = "Dmeson.vrtntrk>=3 && Dmeson.de>=-300. && Dmeson.de<=300. && Dmeson.mbc>=1700. && Dmeson.mbc<=1900. && Dmeson.pt1>100. && Dmeson.pt1<2000. && Dmeson.pt2>100. && Dmeson.pt2<2000. && Dmeson.chi2t1<1000. && Dmeson.chi2t2<1000. && Dmeson.nhitst1>23. && Dmeson.nhitst2>23. && Dmeson.nhitst1<=1000. && Dmeson.nhitst2<=1000. && Dmeson.rr1<0.1 && Dmeson.rr2<0.1 && Dmeson.zip1>-12. && Dmeson.zip1<12. && Dmeson.zip2>-12. && Dmeson.zip2<12. && Dmeson.ecls1<1000. && Dmeson.ecls2<1000. && (Dmeson.mulayerhits2+Dmeson.mulayerhits3)<=1";
