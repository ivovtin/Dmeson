...
void chain(){
	...
	for(int i=1; i<=293; i++)   //signal 2016+2017
	{
	...
	{
	    tt->Add(TString::Format("/spool/users/ovtin/outDmeson/D0/dataPcorr2004_kineFit_1.030/psi3770_to_D0meson_%d.root",i).Data());
	}
    }
