{
  ...
  load_sig("/spool/users/ovtin/outDmeson/D0/results/fitsD0/dat/kp_signal_def_woDCnoise.dat");
  ...
  write_par("par/sig_def_woDCnoise.par", 30, sig_par, sig_epar);
  //gen_sig("/spool/users/ovtin/outDmeson/D0/results/fitsD0/gen/sig_def.gen", num_sig, sig_par, 0.);
  gen_sig("/spool/users/ovtin/outDmeson/D0/results/fitsD0/gen/sig_def_woDCnoise.gen", num_sig, sig_par, 0.);
}
