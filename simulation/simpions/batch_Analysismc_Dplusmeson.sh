...
# -------------------------------------------
# --             Enviroment                --
##$ -v PATH=$PATH:$HOME/release/KdRunFastMon,LD_LIBRARY_PATH=/usr/local/root/lib/root:/home/ovtin/development/lib,KDBHOST=bison-2
#$ -v PATH=$PATH:$HOME/release/KdRunFastMon,LD_LIBRARY_PATH=/usr/local/root/lib/root:/home/ovtin/development/lib,KDBHOST=localhost
# -------------------------------------------
# --             Queue list                --
##$ -soft
##$ -hard
...
#BG continium
simOn=1
outfile="/store/users/ovtin/outDmeson/simulation/outsimDplus/Bkg_pions/KemcAllowedOn_kNoiseReject3_kXTKey1_KcExp0_ATC_S1.0_A6.0_Z0.0/psi3770_to_simDplusmeson_pions_"$i".root"
mintracks=3
maxtracks=20
minbeamtracks=0
minIPtracks=0
...
########################################################################################################
inruns="/store/users/ovtin/outDmeson/simulation/pionsGen301/simDmeson000001.dat"
#
if [ $i == 1 ]; then
...
########################################################################################################
if [ $i -ge 11 ]; then
inruns="/spool/users/ovtin/outDmeson/simulation/pionsGen301/simDmeson000002.dat"
fi
...
#######################################################################################################
if [ $i -ge 21 ]; then
inruns="/store/users/ovtin/outDmeson/simulation/pionsGen301/simDmeson000003.dat"
fi
...
#######################################################################################################
if [ $i -ge 31 ]; then
inruns="/store/users/ovtin/outDmeson/simulation/pionsGen301/simDmeson000004.dat"
fi
...
#######################################################################################################
if [ $i -ge 41 ]; then
inruns="/store/users/ovtin/outDmeson/simulation/pionsGen301/simDmeson000005.dat"
fi
...
#######################################################################################################
if [ $i -ge 51 ]; then
inruns="/store/users/ovtin/outDmeson/simulation/pionsGen301/simDmeson000006.dat"
fi
...
#######################################################################################################
if [ $i -ge 61 ]; then
inruns="/store/users/ovtin/outDmeson/simulation/pionsGen301/simDmeson000007.dat"
fi
...
#######################################################################################################
if [ $i -ge 71 ]; then
inruns="/store/users/ovtin/outDmeson/simulation/pionsGen301/simDmeson000008.dat"
fi
...
#######################################################################################################
if [ $i -ge 81 ]; then
inruns="/store/users/ovtin/outDmeson/simulation/pionsGen301/simDmeson000009.dat"
fi
...
#######################################################################################################
if [ $i -ge 91 ]; then
inruns="/store/users/ovtin/outDmeson/simulation/pionsGen301/simDmeson000010.dat"
fi
...
#######################################################################################################
if [ $i -ge 101 ]; then
inruns="/store/users/ovtin/outDmeson/simulation/pionsGen301/simDmeson000011.dat"
fi
