...
#Signal
simOn=1
outfile="/store/users/ovtin/outDmeson/simulation/outsimD0/Signal/KemcAllowedOn_kNoiseReject3_kXTKey1_KcExp0_S1.0_A6.0_Z0.0_woATC/psi3770_to_simD0mesonSignal_"$i".root"
##mintracks=3
mintracks=2
maxtracks=20
minbeamtracks=0
