...
#BG ee_to_DD
simOn=1
outfile="/store/users/ovtin/outDmeson/simulation/outsimD0/Bkg_eetoDD/KemcAllowedOn_kNoiseReject3_kXTKey1_KcExp0_ATC_S1.0_A6.0_Z0.0_syst_isr_plus_sigma/psi3770_to_simD0mesonBkg_eetoDD_"$i".root"
mintracks=3
maxtracks=15
minbeamtracks=0
minIPtracks=0
...
########################################################################################################
inruns="/store/users/ovtin/outDmeson/simulation/outsimD0/Bkg_eetoDD/syst_isr_plus_sigma/simDmeson000001.dat"
#
if [ $i == 1 ]; then
...
########################################################################################################
if [ $i -ge 18 ]; then
inruns="/store/users/ovtin/outDmeson/simulation/outsimD0/Bkg_eetoDD/syst_isr_plus_sigma/simDmeson000002.dat"
fi
...
#######################################################################################################
if [ $i -ge 35 ]; then
inruns="/store/users/ovtin/outDmeson/simulation/outsimD0/Bkg_eetoDD/syst_isr_plus_sigma/simDmeson000003.dat"
fi
...
#######################################################################################################
if [ $i -ge 52 ]; then
inruns="/store/users/ovtin/outDmeson/simulation/outsimD0/Bkg_eetoDD/syst_isr_plus_sigma/simDmeson000004.dat"
fi
...
#######################################################################################################
if [ $i -ge 69 ]; then
inruns="/store/users/ovtin/outDmeson/simulation/outsimD0/Bkg_eetoDD/syst_isr_plus_sigma/simDmeson000005.dat"
fi
...
#######################################################################################################
if [ $i -ge 86 ]; then
inruns="/store/users/ovtin/outDmeson/simulation/outsimD0/Bkg_eetoDD/syst_isr_plus_sigma/simDmeson000006.dat"
fi
...
#######################################################################################################
if [ $i -ge 103 ]; then
inruns="/store/users/ovtin/outDmeson/simulation/outsimD0/Bkg_eetoDD/syst_isr_plus_sigma/simDmeson000007.dat"
fi
...
#######################################################################################################
if [ $i -ge 120 ]; then
inruns="/store/users/ovtin/outDmeson/simulation/outsimD0/Bkg_eetoDD/syst_isr_plus_sigma/simDmeson000008.dat"
fi
...
#######################################################################################################
if [ $i -ge 137 ]; then
inruns="/store/users/ovtin/outDmeson/simulation/outsimD0/Bkg_eetoDD/syst_isr_plus_sigma/simDmeson000009.dat"
fi
...
#######################################################################################################
if [ $i -ge 154 ]; then
inruns="/store/users/ovtin/outDmeson/simulation/outsimD0/Bkg_eetoDD/syst_isr_plus_sigma/simDmeson000010.dat"
fi
...
#######################################################################################################
if [ $i -ge 171 ]; then
inruns="/store/users/ovtin/outDmeson/simulation/outsimD0/Bkg_eetoDD/syst_isr_plus_sigma/simDmeson000011.dat"
fi
...
#######################################################################################################
if [ $i -ge 188 ]; then
inruns="/store/users/ovtin/outDmeson/simulation/outsimD0/Bkg_eetoDD/syst_isr_plus_sigma/simDmeson000012.dat"
fi
...
#######################################################################################################
if [ $i -ge 205 ]; then
inruns="/store/users/ovtin/outDmeson/simulation/outsimD0/Bkg_eetoDD/syst_isr_plus_sigma/simDmeson000013.dat"
fi
