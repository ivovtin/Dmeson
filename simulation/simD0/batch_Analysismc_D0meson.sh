...
#######################################################################################################
if [ $i -ge 45 ]; then
inruns="/spool/users/ovtin/outDmeson/simulation/outsimD0/Signal/simDmeson000006.dat"
fi
...
#######################################################################################################
if [ $i -ge 55 ]; then
inruns="/spool/users/ovtin/outDmeson/simulation/outsimD0/Signal/simDmeson000007.dat"
fi
...
#######################################################################################################
if [ $i -ge 65 ]; then
inruns="/spool/users/ovtin/outDmeson/simulation/outsimD0/Signal/simDmeson000008.dat"
fi
...
#######################################################################################################
if [ $i -ge 75 ]; then
inruns="/spool/users/ovtin/outDmeson/simulation/outsimD0/Signal/simDmeson000009.dat"
fi
...
#######################################################################################################
if [ $i -ge 85 ]; then
inruns="/spool/users/ovtin/outDmeson/simulation/outsimD0/Signal/simDmeson0000010.dat"
fi
...
#######################################################################################################
if [ $i -ge 95 ]; then
inruns="/spool/users/ovtin/outDmeson/simulation/outsimD0/Signal/simDmeson0000011.dat"
fi
...
#######################################################################################################
if [ $i -ge 105 ]; then
inruns="/spool/users/ovtin/outDmeson/simulation/outsimD0/Signal/simDmeson0000012.dat"
fi
...
##$HOME/development/Dmeson/analysis_D0meson -D $simOn -v $NumFirstExpRun -m $NumLastExpRun -M $NevRate -a $mintracks -d $maxtracks -b $minbeamtracks -p $minIPtracks -h $maxIPtracks -s $minPt -j $maxPt -t $minClusterEnergy -e $minTotalEnergy -c $minClusters -l $maxClusters -k $minClustersLKr -i $minClustersCsI -u $maxtchi2 -q $minNhits -o $outfile -f $kinefit $inruns -w $nevbegin -g $nevend > /dev/null
