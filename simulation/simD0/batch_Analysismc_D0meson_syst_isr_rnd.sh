...
#Signal
simOn=1
outfile="/store/users/ovtin/outDmeson/simulation/outsimD0/Signal/KemcAllowedOn_kNoiseReject3_kXTKey1_KcExp0_ATC_S1.0_A6.0_Z0.0_syst_isr_rnd/psi3770_to_simD0mesonSignal_"$i".root"
mintracks=2
maxtracks=20
minbeamtracks=0
minIPtracks=0
...
########################################################################################################
inruns="/store/users/ovtin/outDmeson/simulation/outsimD0/Signal/syst_isr_rnd/simDmeson000001.dat"
#
if [ $i == 1 ]; then
...
#######################################################################################################
if [ $i -ge 24 ]; then
inruns="/spool/users/ovtin/outDmeson/simulation/outsimD0/Signal/syst_isr_rnd/simDmeson000002.dat"
fi
...
#######################################################################################################
if [ $i -ge 47 ]; then
inruns="/spool/users/ovtin/outDmeson/simulation/outsimD0/Signal/syst_isr_rnd/simDmeson000003.dat"
fi
...
#######################################################################################################
if [ $i -ge 70 ]; then
inruns="/spool/users/ovtin/outDmeson/simulation/outsimD0/Signal/syst_isr_rnd/simDmeson000004.dat"
fi
...
#######################################################################################################
if [ $i -ge 93 ]; then
inruns="/spool/users/ovtin/outDmeson/simulation/outsimD0/Signal/syst_isr_rnd/simDmeson000005.dat"
fi
