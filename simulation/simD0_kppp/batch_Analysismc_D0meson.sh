...
#Signal
simOn=1
##outfile="/store/users/ovtin/outDmeson/simulation/outsimD0_kppp/Signal/KemcAllowedOn_kNoiseReject3_kXTKey1_KcExp0_ATC_S1.0_A6.0_Z0.0_kinFit/psi3770_to_simD0mesonSignal_"$i".root"
outfile="/store/users/ovtin/outDmeson/simulation/outsimD0_kppp/Signal/KemcAllowedOn_kNoiseReject3_kXTKey1_KcExp0_ATC_S1.0_A6.0_Z0.0_kinFit_v2/psi3770_to_simD0mesonSignal_"$i".root"
mintracks=4
maxtracks=30
minbeamtracks=0
minIPtracks=0
...
#######################################################################################################
if [ $i -ge 26 ]; then
inruns="/store/users/ovtin/outDmeson/simulation/outsimD0_kppp/Signal/simDmeson000002.dat"
fi
...
#######################################################################################################
if [ $i -ge 51 ]; then
inruns="/store/users/ovtin/outDmeson/simulation/outsimD0_kppp/Signal/simDmeson000003.dat"
fi
...
#######################################################################################################
if [ $i -ge 76 ]; then
inruns="/store/users/ovtin/outDmeson/simulation/outsimD0_kppp/Signal/simDmeson000004.dat"
fi
...
#######################################################################################################
if [ $i -ge 101 ]; then
inruns="/store/users/ovtin/outDmeson/simulation/outsimD0_kppp/Signal/simDmeson000005.dat"
fi
