...
########################################################################################################
if [ $i -ge 18 ]; then
inruns="/store/users/ovtin/outDmeson/simulation/outsimD0_kppp/Bkg_eetoDD/simDmeson000002.dat"
fi
...
#######################################################################################################
if [ $i -ge 34 ]; then
inruns="/store/users/ovtin/outDmeson/simulation/outsimD0_kppp/Bkg_eetoDD/simDmeson000003.dat"
fi
...
#######################################################################################################
if [ $i -ge 47 ]; then
inruns="/store/users/ovtin/outDmeson/simulation/outsimD0_kppp/Bkg_eetoDD/simDmeson000004.dat"
fi
...
#######################################################################################################
if [ $i -ge 66 ]; then
inruns="/store/users/ovtin/outDmeson/simulation/outsimD0_kppp/Bkg_eetoDD/simDmeson000005.dat"
fi
...
#######################################################################################################
if [ $i -ge 86 ]; then
inruns="/store/users/ovtin/outDmeson/simulation/outsimD0_kppp/Bkg_eetoDD/simDmeson000006.dat"
fi
...
#######################################################################################################
if [ $i -ge 105 ]; then
inruns="/store/users/ovtin/outDmeson/simulation/outsimD0_kppp/Bkg_eetoDD/simDmeson000007.dat"
fi
...
#######################################################################################################
if [ $i -ge 125 ]; then
inruns="/store/users/ovtin/outDmeson/simulation/outsimD0_kppp/Bkg_eetoDD/simDmeson000008.dat"
fi
...
#######################################################################################################
if [ $i -ge 145 ]; then
inruns="/store/users/ovtin/outDmeson/simulation/outsimD0_kppp/Bkg_eetoDD/simDmeson000009.dat"
fi
...
#######################################################################################################
if [ $i -ge 164 ]; then
inruns="/store/users/ovtin/outDmeson/simulation/outsimD0_kppp/Bkg_eetoDD/simDmeson000010.dat"
fi
...
#######################################################################################################
if [ $i -ge 184 ]; then
inruns="/store/users/ovtin/outDmeson/simulation/outsimD0_kppp/Bkg_eetoDD/simDmeson000011.dat"
fi
...
#######################################################################################################
if [ $i -ge 203 ]; then
inruns="/store/users/ovtin/outDmeson/simulation/outsimD0_kppp/Bkg_eetoDD/simDmeson000012.dat"
fi
...
$HOME/development/Dmeson/analysis_D0kppp -D $simOn -v $NumFirstExpRun -m $NumLastExpRun -M $NevRate -S 1.0 -A 6.0 -Z 0.0 -a $mintracks -d $maxtracks -b $minbeamtracks -p $minIPtracks -h $maxIPtracks -s $minPt -j $maxPt -t $minClusterEnergy -e $minTotalEnergy -c $minClusters -l $maxClusters -k $minClustersLKr -i $minClustersCsI -u $maxtchi2 -q $minNhits -o $outfile -f $kinefit $inruns -w $nevbegin -g $nevend
