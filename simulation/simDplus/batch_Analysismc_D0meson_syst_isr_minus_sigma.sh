...
#Signal
simOn=1
outfile="/store/users/ovtin/outDmeson/simulation/outsimDplus/Signal/KemcAllowedOn_kNoiseReject3_kXTKey1_KcExp0_ATC_S1.0_A6.0_Z0.0_syst_isr_minus_sigma/psi3770_to_simDplusmesonSignal_"$i".root"
mintracks=3
maxtracks=12
minbeamtracks=0
minIPtracks=0
...
#
########################################################################################################
inruns="/store/users/ovtin/outDmeson/simulation/outsimDplus/Signal/syst_isr_minus_sigma/simDmeson000001.dat"
#
if [ $i == 1 ]; then
...
########################################################################################################
if [ $i -ge 10 ]; then
inruns="/store/users/ovtin/outDmeson/simulation/outsimDplus/Signal/syst_isr_minus_sigma/simDmeson000002.dat"
fi
#
if [ $i == 10 ]; then
...
#######################################################################################################
if [ $i -ge 18 ]; then
inruns="/store/users/ovtin/outDmeson/simulation/outsimDplus/Signal/syst_isr_minus_sigma/simDmeson000003.dat"
fi
...
#######################################################################################################
if [ $i -ge 25 ]; then
inruns="/store/users/ovtin/outDmeson/simulation/outsimDplus/Signal/syst_isr_minus_sigma/simDmeson000004.dat"
fi
...
#######################################################################################################
if [ $i -ge 35 ]; then
inruns="/store/users/ovtin/outDmeson/simulation/outsimDplus/Signal/syst_isr_minus_sigma/simDmeson000005.dat"
fi
...
#######################################################################################################
if [ $i -ge 45 ]; then
inruns="/store/users/ovtin/outDmeson/simulation/outsimDplus/Signal/syst_isr_minus_sigma/simDmeson000006.dat"
fi
...
#######################################################################################################
if [ $i -ge 55 ]; then
inruns="/store/users/ovtin/outDmeson/simulation/outsimDplus/Signal/syst_isr_minus_sigma/simDmeson000007.dat"
fi
...
#######################################################################################################
if [ $i -ge 65 ]; then
inruns="/store/users/ovtin/outDmeson/simulation/outsimDplus/Signal/syst_isr_minus_sigma/simDmeson000008.dat"
fi
...
#######################################################################################################
if [ $i -ge 75 ]; then
inruns="/store/users/ovtin/outDmeson/simulation/outsimDplus/Signal/syst_isr_minus_sigma/simDmeson000009.dat"
fi
...
#######################################################################################################
if [ $i -ge 85 ]; then
inruns="/store/users/ovtin/outDmeson/simulation/outsimDplus/Signal/syst_isr_minus_sigma/simDmeson000010.dat"
fi
...
#######################################################################################################
if [ $i -ge 95 ]; then
inruns="/store/users/ovtin/outDmeson/simulation/outsimDplus/Signal/syst_isr_minus_sigma/simDmeson000011.dat"
fi
...
#######################################################################################################
if [ $i -ge 105 ]; then
inruns="/store/users/ovtin/outDmeson/simulation/outsimDplus/Signal/syst_isr_minus_sigma/simDmeson000012.dat"
fi
