...
#Bkg eetoDD
simOn=1
outfile="/store/users/ovtin/outDmeson/simulation/outsimDplus/Bkg_eetoDD/KemcAllowedOn_kNoiseReject3_kXTKey1_KcExp0_ATC_S1.0_A6.0_Z0.0_syst_isr_rnd/psi3770_to_simDplusmesonBkg_eetoDD_"$i".root"
mintracks=3
maxtracks=12
minbeamtracks=0
minIPtracks=0
...
########################################################################################################
inruns="/store/users/ovtin/outDmeson/simulation/outsimDplus/Bkg_eetoDD/syst_isr_rnd/simDmeson000001.dat"
#
if [ $i == 1 ]; then
...
########################################################################################################
if [ $i -ge 19 ]; then
inruns="/store/users/ovtin/outDmeson/simulation/outsimDplus/Bkg_eetoDD/syst_isr_rnd/simDmeson000002.dat"
fi
...
#######################################################################################################
if [ $i -ge 37 ]; then
inruns="/store/users/ovtin/outDmeson/simulation/outsimDplus/Bkg_eetoDD/syst_isr_rnd/simDmeson000003.dat"
fi
...
#######################################################################################################
if [ $i -ge 55 ]; then
inruns="/store/users/ovtin/outDmeson/simulation/outsimDplus/Bkg_eetoDD/syst_isr_rnd/simDmeson000004.dat"
fi
...
#######################################################################################################
if [ $i -ge 73 ]; then
inruns="/store/users/ovtin/outDmeson/simulation/outsimDplus/Bkg_eetoDD/syst_isr_rnd/simDmeson000005.dat"
fi
...
#######################################################################################################
if [ $i -ge 91 ]; then
inruns="/store/users/ovtin/outDmeson/simulation/outsimDplus/Bkg_eetoDD/syst_isr_rnd/simDmeson000006.dat"
fi
...
#######################################################################################################
if [ $i -ge 109 ]; then
inruns="/store/users/ovtin/outDmeson/simulation/outsimDplus/Bkg_eetoDD/syst_isr_rnd/simDmeson000007.dat"
fi
...
#######################################################################################################
if [ $i -ge 127 ]; then
inruns="/store/users/ovtin/outDmeson/simulation/outsimDplus/Bkg_eetoDD/syst_isr_rnd/simDmeson000008.dat"
fi
...
#######################################################################################################
if [ $i -ge 145 ]; then
inruns="/store/users/ovtin/outDmeson/simulation/outsimDplus/Bkg_eetoDD/syst_isr_rnd/simDmeson000009.dat"
fi
...
#######################################################################################################
if [ $i -ge 163 ]; then
inruns="/store/users/ovtin/outDmeson/simulation/outsimDplus/Bkg_eetoDD/syst_isr_rnd/simDmeson000010.dat"
fi
...
#######################################################################################################
if [ $i -ge 181 ]; then
inruns="/store/users/ovtin/outDmeson/simulation/outsimDplus/Bkg_eetoDD/syst_isr_rnd/simDmeson000011.dat"
fi
...
#######################################################################################################
if [ $i -ge 199 ]; then
inruns="/store/users/ovtin/outDmeson/simulation/outsimDplus/Bkg_eetoDD/syst_isr_rnd/simDmeson000012.dat"
fi
