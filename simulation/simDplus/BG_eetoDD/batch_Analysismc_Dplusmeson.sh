...
#Bkg eetoDD
simOn=1
outfile="/spool/users/ovtin/outDmeson/simulation/outsimDplus/Bkg_eetoDD/psi3770_to_simDplusmesonBkg_eetoDD_"$i".root"
mintracks=3
maxtracks=12
minbeamtracks=0
minIPtracks=0
...
########################################################################################################
inruns="/spool/users/ovtin/outDmeson/simulation/outsimDplus/Bkg_eetoDD/simDmeson000001.dat"
#
if [ $i == 1 ]; then
...
########################################################################################################
if [ $i -ge 18 ]; then
inruns="/spool/users/ovtin/outDmeson/simulation/outsimDplus/Bkg_eetoDD/simDmeson000002.dat"
fi
...
#######################################################################################################
if [ $i -ge 34 ]; then
inruns="/spool/users/ovtin/outDmeson/simulation/outsimDplus/Bkg_eetoDD/simDmeson000003.dat"
fi
...
#######################################################################################################
if [ $i -ge 47 ]; then
inruns="/spool/users/ovtin/outDmeson/simulation/outsimDplus/Bkg_eetoDD/simDmeson000004.dat"
fi
...
#######################################################################################################
if [ $i -ge 66 ]; then
inruns="/spool/users/ovtin/outDmeson/simulation/outsimDplus/Bkg_eetoDD/simDmeson000005.dat"
fi
...
#######################################################################################################
if [ $i -ge 86 ]; then
inruns="/spool/users/ovtin/outDmeson/simulation/outsimDplus/Bkg_eetoDD/simDmeson000006.dat"
fi
...
#######################################################################################################
if [ $i -ge 105 ]; then
inruns="/spool/users/ovtin/outDmeson/simulation/outsimDplus/Bkg_eetoDD/simDmeson000007.dat"
fi
...
#######################################################################################################
if [ $i -ge 125 ]; then
inruns="/spool/users/ovtin/outDmeson/simulation/outsimDplus/Bkg_eetoDD/simDmeson000008.dat"
fi
...
#######################################################################################################
if [ $i -ge 145 ]; then
inruns="/spool/users/ovtin/outDmeson/simulation/outsimDplus/Bkg_eetoDD/simDmeson000009.dat"
fi
...
#######################################################################################################
if [ $i -ge 164 ]; then
inruns="/spool/users/ovtin/outDmeson/simulation/outsimDplus/Bkg_eetoDD/simDmeson0000010.dat"
fi
...
#######################################################################################################
if [ $i -ge 184 ]; then
inruns="/spool/users/ovtin/outDmeson/simulation/outsimDplus/Bkg_eetoDD/simDmeson0000011.dat"
fi
...
#######################################################################################################
if [ $i -ge 203 ]; then
inruns="/spool/users/ovtin/outDmeson/simulation/outsimDplus/Bkg_eetoDD/simDmeson0000012.dat"
fi
