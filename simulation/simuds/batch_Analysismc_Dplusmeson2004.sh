...
#BG continium
simOn=1
##outfile="/store/users/ovtin/outDmeson/simulation/outsimDplus/Bkg_continium2004/KemcAllowedOn_kNoiseReject3_kXTKey1_KcExp0_ATC_S1.0_A4.5_Z0.0/psi3770_to_simDplusmeson_ee_to_qq_"$i".root"
outfile="/store/users/ovtin/outDmeson/simulation/outsimDplus/Bkg_continium2004/KemcAllowedOff_kNoiseReject3_kXTKey1_KcExp0_ATC_S1.0_A4.5_Z0.0/psi3770_to_simDplusmeson_ee_to_qq_"$i".root"
