...
#BG continium
simOn=1
outfile="/store/users/ovtin/outDmeson/simulation/outsimD0_kppp/Bkg_continium/KemcAllowedOn_kNoiseReject3_kXTKey1_KcExp0_ATC_S1.0_A6.0_Z0.0/psi3770_to_simD0meson_ee_to_qq_"$i".root"
mintracks=4
maxtracks=20
minbeamtracks=0
minIPtracks=0
