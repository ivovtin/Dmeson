...
#BG continium
simOn=1
outfile="/store/users/ovtin/outDmeson/simulation/outsimDplus/Bkg_continium/KemcAllowedOn_kNoiseReject3_kXTKey1_KcExp0_ATC_S1.0_A6.0_Z0.0_dedx_tof/psi3770_to_simDplusmeson_ee_to_qq_"$i".root"
mintracks=3
maxtracks=20
minbeamtracks=0
minIPtracks=0
