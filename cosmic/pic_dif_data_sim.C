void pic_dif_data_sim()
{
    ...
    TFile *inSim = TFile::Open("sim_cosmic_sig_method2_" + pref_out + ".root");
    ...
    c1.Update();
    c1.SaveAs(dir_out + "compare_data_sim_2016-17_method2_corr_" + pref_out + ".png");
    c1.SaveAs(dir_out + "compare_data_sim_2016-17_method2_corr_" + pref_out + ".eps");
    c1.SaveAs(dir_out + "compare_data_sim_2016-17_" + pref_out + ".root");
    ...
    c2.Update();
    c2.SaveAs(dir_out + "compare_data_sim_2016-17_method2_corr_" + pref_out + "_dp.png");
    c2.SaveAs(dir_out + "compare_data_sim_2016-17_method2_corr_" + pref_out + "_dp.eps");
