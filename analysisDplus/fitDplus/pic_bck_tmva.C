{
  ...
  TString data_file = "kpp_uds_KemcAllowedOn_kNoiseReject3_kXTKey1_KcExp0_S1.0_A6.0_Z0.0_atc_tof_dedx_tmva_0.70_ATC.dat";
  TString type = "atc_tof_dedx_S1.0_A6.0_Z0.0" + dat_dirname + "_test";

  TString gen_dirname = dat_dirname + "test";
