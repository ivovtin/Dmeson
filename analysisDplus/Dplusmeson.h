...
void chain(){
	...
	//for(int i=1; i<=584; i++)   //signal 2016+2017
        {
	    //tt->Add(TString::Format("/store/users/ovtin/outDmeson/Dplus/dataPcorr_1.0165_kNoiseReject3_atc_KemcAllowediOn/psi3770_to_D0meson_%d.root",i).Data());
	    //tt->Add(TString::Format("/store/users/ovtin/outDmeson/Dplus/dataPcorr_1.0125_kNoiseReject3_atc_KemcAllowediOn/psi3770_to_D0meson_%d.root",i).Data());
	    //tt->Add(TString::Format("/store/users/ovtin/outDmeson/Dplus/dataPcorr_1.0135_kNoiseReject3_atc_KemcAllowediOn/psi3770_to_D0meson_%d.root",i).Data());
	    tt->Add(TString::Format("/store/users/ovtin/outDmeson/Dplus/dataPcorr_1.0150_kNoiseReject3_atc_KemcAllowediOn/psi3770_to_D0meson_%d.root",i).Data());
	    //tt->Add(TString::Format("/store/users/ovtin/outDmeson/Dplus/dataPcorr_1.0210_kNoiseReject3_atc_KemcAllowediOn/psi3770_to_D0meson_%d.root",i).Data());
            ////////////
	    //tt->Add(TString::Format("/store/users/ovtin/outDmeson/Dplus/dataPcorr_1.0_kNoiseReject3_atc/psi3770_to_D0meson_%d.root",i).Data());
	    //tt->Add(TString::Format("/store/users/ovtin/outDmeson/Dplus/dataPcorr_1.0170_kNoiseReject3_atc/psi3770_to_D0meson_%d.root",i).Data());
	    //tt->Add(TString::Format("/store/users/ovtin/outDmeson/Dplus/dataPcorr_1.0180_kNoiseReject3_atc/psi3770_to_D0meson_%d.root",i).Data());
	}
    }
    else if (key==4){
	...
	{
	    tt->Add(TString::Format("/store/users/ovtin/outDmeson/simulation/outsimDplus/Signal/KemcAllowedOn_kNoiseReject3_kXTKey1_KcExp0_ATC_S1.0_A6.0_Z0.0_dedx_tof/psi3770_to_simDplusmesonSignal_%d.root",i).Data());
	}
    }
    else if (key==2){
	//for(int i=1; i<=221; i++)   //uds BG
	for(int i=1; i<=12; i++)   //uds BG
	{
	    //if( i!=5 && i!=61 && i!=69 && i!=70 && i!=114 && i!=136 && i!=163 && i!=213 && i!=215 )
	    //{
		tt->Add(TString::Format("/store/users/ovtin/outDmeson/simulation/outsimDplus/Bkg_continium/KemcAllowedOn_kNoiseReject3_kXTKey1_KcExp0_ATC_S1.0_A6.0_Z0.0_dedx_tof/psi3770_to_simDplusmeson_ee_to_qq_%d.root",i).Data());
	    //}
	}
    }
    else if (key==3){
