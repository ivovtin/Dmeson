...
void chain(){
	...
	{
	    //tt->Add(TString::Format("/spool/users/ovtin/outDmeson/Dplus/dataPcorr_1.0_kNoiseReject3_atc/psi3770_to_D0meson_%d.root",i).Data());
	    ...
	    tt->Add(TString::Format("/spool/users/ovtin/outDmeson/Dplus/dataPcorr_1.0180_kNoiseReject3_atc/psi3770_to_D0meson_%d.root",i).Data());
	}
    }
    else if (key==4){
