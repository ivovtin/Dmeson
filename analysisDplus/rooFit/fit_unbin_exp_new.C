...
void fit_unbin_exp_new()
{
    ...
    //TString coef = "1.0140";
    //TString dataFile = "kpp_exp_2016-17_KemcAllowedOn_kNoiseReject3_1.0130_atc_tof_dedx_ATC.dat";
    //TString coef = "1.0130";
    //TString dataFile = "kpp_exp_2016-17_KemcAllowedOn_kNoiseReject3_1.0120_atc_tof_dedx_ATC.dat";
    //TString coef = "1.0120";
    //TString dataFile = "kpp_exp_2016-17_KemcAllowedOn_kNoiseReject3_1.0150_atc_tof_dedx_ATC.dat";
    //TString coef = "1.0150";
    //TString dataFile = "kpp_exp_2016-17_KemcAllowedOn_kNoiseReject3_1.0170_atc_tof_dedx_ATC.dat";
    //TString coef = "1.0170";
    ...
    //TString dataFile = "kpp_exp_2016-17_KemcAllowedOn_kNoiseReject3_1.0140_atc_tof_dedx_ionization_losses_plus1sigma_ATC.dat";
    ...
    //TString dataFile = "kpp_exp_2016-17_KemcAllowedOn_kNoiseReject3_1.0140_atc_tof_dedx_ionization_losses_minus1sigma_ATC.dat";
    //TString coef = "1.0140";

    //Syst momres
    //TString TypeDir = "KemcAllowedOn_kNoiseReject3_kXTKey1_KcExp0_atc_tof_dedx_0.80_0.70_Pcuttof380_dedx_OR_atc_with_Cuts_chi255_rr0.5_z12_syst_momres_S1.0_A4.8_Z0.0";
    //TString TypeDir = "KemcAllowedOn_kNoiseReject3_kXTKey1_KcExp0_atc_tof_dedx_0.80_0.70_Pcuttof380_dedx_OR_atc_with_Cuts_chi255_rr0.5_z12_syst_momres_S1.0_A7.2_Z0.2";
    ...
    //TString dataFile = "kpp_exp_2016-17_KemcAllowedOn_kNoiseReject3_1.0140_atc_dedx_ATC.dat";
    //TString coef = "1.0140";

    //atc+tof
    //TString TypeDir = "KemcAllowedOn_kNoiseReject3_kXTKey1_KcExp0_atc_tof_Pcuttof380_with_Cuts_chi255_rr0.5_z12";
    //TString dataFile = "kpp_exp_2016-17_KemcAllowedOn_kNoiseReject3_1.0140_atc_tof_ATC.dat";
    //TString coef = "1.0140";

    //tof
    //TString TypeDir = "KemcAllowedOn_kNoiseReject3_kXTKey1_KcExp0_tof_Pcuttof380_with_Cuts_chi255_rr0.5_z12";
    //TString dataFile = "kpp_exp_2016-17_KemcAllowedOn_kNoiseReject3_1.0140_tof_ATC.dat";
    //TString coef = "1.0140";
    ...
    RooRealVar sig_mbcw_shift("sig_mbcw_shift", "sig_mbcw_shift", sig_par[8], sig_par[8], sig_par[8]);
    RooRealVar sig_mbcw_frac("sig_mbcw_frac", "sig_mbcw_frac", sig_par[9], sig_par[9], sig_par[9]);
    RooRealVar sig_mbcw_sigma("sig_mbcw_sigma", "sig_mbcw_sigma", sig_par[10], sig_par[10], sig_par[10]);
    RooRealVar sig_dew_sigma("sig_dew_sigma", "sig_dew_sigma", sig_par[11], sig_par[11], sig_par[11]);
    RooRealVar sig_mbcdew_corr("sig_mbcdew_corr", "sig_mbcdew_corr", sig_par[12], sig_par[12], sig_par[12]);
    RooRealVar sig_dpsig("sig_dpsig", "sig_dpsig", sig_par[13], sig_par[13], sig_par[13]);

    RooRealVar sig_dbck_alpha_mbc("sig_dbck_alpha_mbc", "sig_dbck_alpha_mbc", sig_par[14], sig_par[14], sig_par[14]);
    RooRealVar sig_dbck_alpha_de("sig_dbck_alpha_de", "sig_dbck_alpha_de", sig_par[15], sig_par[15], sig_par[15]);
    RooRealVar sig_dbck_ebeam("sig_dbck_ebeam", "sig_dbck_ebeam", sig_par[16],sig_par[16],sig_par[16]);
    RooRealVar sig_dbck_de_mean("sig_dbck_de_mean", "sig_dbck_de_mean", sig_par[17], sig_par[17], sig_par[17]);
    RooRealVar sig_dbck_de_width("sig_dbck_de_width", "sig_dbck_de_width", sig_par[18], sig_par[18], sig_par[18]);
    RooRealVar sig_dbck_de_frac("sig_dbck_de_frac", "sig_dbck_de_frac", sig_par[19], sig_par[19], sig_par[19]);
    RooRealVar sig_dbck_mbc_mean("sig_dbck_mbc_mean", "sig_dbck_mbc_mean", sig_par[20], sig_par[20], sig_par[20]);
    RooRealVar sig_dbck_mbc_sigma0("sig_dbck_mbc_sigma0", "sig_dbck_mbc_sigma0", sig_par[21], sig_par[21], sig_par[21]);
    RooRealVar sig_dbck_mbc_sigma1("sig_dbck_mbc_sigma1", "sig_dbck_mbc_sigma1", sig_par[22], sig_par[22], sig_par[22]);
    RooRealVar sig_dbck_de_mean1("sig_dbck_de_mean1", "sig_dbck_de_mean1", sig_par[23], sig_par[23], sig_par[23]);
    RooRealVar sig_dbck_de_width1("sig_dbck_de_width1", "sig_dbck_de_width1", sig_par[24], sig_par[24], sig_par[24]);
    RooRealVar sig_dbck_de_frac1("sig_dbck_de_frac1", "sig_dbck_de_frac1", sig_par[25], sig_par[25], sig_par[25]);
    RooRealVar sig_dbck_mbc_mean1("sig_dbck_mbc_mean1", "sig_dbck_mbc_mean1", sig_par[26], sig_par[26], sig_par[26]);

    RooSigPdfNew sig_model("sig_model","sig_model", mbc, de, sig_mbc_mean, sig_de_mean, sig_mbcde_corr, sig_mbc_sigma_l, sig_mbc_sigma_r, sig_de_sigma, sig_ebeam, sig_bck, sig_mbcw_shift, sig_mbcw_frac, sig_mbcw_sigma, sig_dew_sigma, sig_mbcdew_corr, sig_dpsig, sig_dbck_alpha_mbc, sig_dbck_alpha_de, sig_dbck_ebeam, sig_dbck_de_mean, sig_dbck_de_width, sig_dbck_de_frac, sig_dbck_mbc_mean, sig_dbck_mbc_sigma0, sig_dbck_mbc_sigma1, sig_dbck_de_mean1, sig_dbck_de_width1, sig_dbck_de_frac1, sig_dbck_mbc_mean1);      
    sig_model.Print();
