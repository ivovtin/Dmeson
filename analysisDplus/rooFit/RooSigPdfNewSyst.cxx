...
ClassImp(RooSigPdfNewSyst); 

 RooSigPdfNewSyst::RooSigPdfNewSyst(const char *name, const char *title, 
                        RooAbsReal& _mbc,
                        RooAbsReal& _de,
 ...
 RooSigPdfNewSyst::RooSigPdfNewSyst(const RooSigPdfNewSyst& other, const char* name) :  
 ...
 Double_t RooSigPdfNewSyst::evaluate() const 
 { 
   ...
   if (fabs(0.1)<dp_max) {
     ...
     return dpsig*desig*mbcsig*dp_max+
